angular.module('external.customerReviewsModule')
    .controller('external.customerReviewsModule.reviewsController', ['$scope', 'external.customerReviewsModule.webApi', 'platformWebApp.bladeUtils', 'uiGridConstants', 'platformWebApp.uiGridHelper',
        function ($scope, api, utils, uiGridConstants, uiGridHelper) {
            $scope.uiGridConstants = uiGridConstants;

            var blade = $scope.blade;
            var bladeNavigationService = utils.bladeNavigationService;

            blade.refresh = function () {
                blade.isLoading = true;
                api.search(angular.extend(filter, {
